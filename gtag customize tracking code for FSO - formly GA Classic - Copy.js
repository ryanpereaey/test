...
Analytics.AddProperty = function(a, b, c) {
    ...
    if (b == Analytics.CLASSIC) Analytics.isProduction && null == Analytics.accountType && (Analytics.accountType = b, gtag("config", a), Analytics.TrackPageView(), ga = document.createElement("script"), ga.type = "text/javascript", ga.async = !0, ga.src = ("https:" == document.location.protocol ? "https://ssl" : "http://www") + ".googletagmanager.com/gtag/js", b = document.getElementsByTagName("script")[0], b.parentNode.insertBefore(ga, b));
        ...
        } else "function" == typeof ga && (ga("create", a, c),   gtag("config", a))
};
...
Analytics.TrackPageView = function() {
    Analytics.accountType == Analytics.CLASSIC ? Analytics.trackHash ? gtag("config", a, { location.pathname + location.search + location.hash}) : gtag("config", a) : Analytics.accountType == Analytics.UNIVERSAL && ga && (Analytics.trackHash ? gtag("config", a, { location.pathname + location.search + location.hash}) : gtag("config", a))
};
